					...
					<div class="toolbar">
						...
						<div
							...
							<div class="page-title d-flex flex-column me-5">
								<!--begin::Title-->
								<h1 class="d-flex flex-column text-dark fw-bolder fs-3 mb-0">Customer List</h1>
								<!--end::Title-->
								<!--begin::Breadcrumb-->
									...
									<table class="table align-middle table-row-dashed fs-6 gy-5"
										...
										<tbody class="fw-bold text-gray-600">
											...
											<tr>
												...
												<td>
													<a href="#"
														class="text-gray-600 text-hover-primary mb-1">mikaela@pexcom.com</a>
												</td>
												<!--end::Email=-->
												<!--begin::Company=-->
												<td>Keenthemes</td>
