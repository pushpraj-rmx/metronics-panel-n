						...
						<div id="kt_content_container" class="container-xxl">
								...
								<div class="card-body pt-9 pb-0">
									...
									<div class="d-flex flex-wrap flex-sm-nowrap mb-3">
										...
										<div class="flex-grow-1">
											...
											<!--end::Title-->
											<!--begin::Stats-->
											<div class="d-flex flex-wrap flex-stack" style="flex-direction: row-reverse;">
												<!--begin::Wrapper-->
												<div class="d-flex flex-column flex-grow-1 pe-8">
													<p><i>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Architecto quod nisi atque quisquam vero asperiores maxime nostrum quia eaque pariatur accusantium veritatis, ipsam dicta eligendi tempore, aut corporis. Magnam, at?</i></p>
												...
												<div class="d-flex align-items-center w-200px w-sm-300px flex-column mt-3">
													...
													<div class="h-5px mx-3 w-100 bg-light mb-3">
														<div class="bg-success rounded h-5px" role="progressbar" style="width: 80%;" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
													</div>
												</div>
												<!--end::Progress-->
											</div>
							...
							<div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
								...
								<div class="card-header cursor-pointer">
									...
									<!--end::Card title-->
									<!--begin::Action-->
									<a href="./account/settings.html" class="btn btn-primary align-self-center">Edit
										Profile</a>
									<!--end::Action-->
								</div>
								<!--begin::Card header-->
								...
								<div class="card-body p-9">
									...
									<div class="row mb-7">
										...
										<!--begin::Col-->
										<div class="col-lg-8">
											<span class="fw-bolder fs-6 text-gray-800">Dinesh Arora</span>
										</div>
										<!--end::Col-->
									</div>
									<!--end::Row-->
									...
									<div class="row mb-7">
										...
										<div class="col-lg-8 fv-row">
											<span class="fw-bold text-gray-800 fs-6">Investment Portfolio</span>
										</div>
										<!--end::Col-->
									</div>
									<!--end::Input group-->
									...
									<div class="row mb-7">
										...
										<div class="col-lg-8 d-flex align-items-center">
											<span class="fw-bolder fs-6 text-gray-800 me-2">+91 9876 543 210</span>
									...
									<div class="row mb-7">
										<!--begin::Label-->
										<label class="col-lg-4 fw-bold text-muted">Company Profile</label>
										<!--end::Label-->
										<!--begin::Col-->
										<div class="col-lg-8">
											<a href="#" class="fw-bold fs-6 text-gray-800 text-hover-primary">
												Finincial Consultant</a>
										</div>
										<!--end::Col-->
									</div>
									<!--end::Input group-->
									...
									<div class="row mb-7">
										...
										<!--begin::Col-->
										<div class="col-lg-8">
											<span class="fw-bolder fs-6 text-gray-800">email@example.com, +91 - 9876 543 210</span>
										</div>
										<!--end::Col-->
									</div>
									<!--end::Input group-->
									...
									<div class="notice d-flex bg-light-success rounded border-success border border-dashed p-6">
										...
										<span class="svg-icon svg-icon-2tx svg-icon-success me-4">
											<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
												<rect opacity="0.5" x="2" y="2" width="20" height="20" rx="10" fill="dark-green" />
										...
										<div class="d-flex flex-stack flex-grow-1">
											<!--begin::Content-->
											<div class="fw-bold">
												<h4 class="text-gray-900 fw-bolder">You are logged in as SUPERHOST.</h4>
												<div class="fs-6 text-gray-700">
													You can control and modify anything that is displaying on the website.
													<a class="fw-bolder" href="./account/billing.html">Go to website</a>.
												</div>
											</div>
											<!--end::Content-->
										</div>
									...
									<div class="card card-xl-stretch mb-5 mb-xl-10">
										...
										<div class="card-header border-0 pt-5">
											<h3 class="card-title align-items-start flex-column">
												<span class="card-label fw-bolder fs-3 mb-1">Manage Overview</span>
											</h3>
											<div class="card-toolbar">
												...
												<!--begin::Menu 1-->
												<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_614858aa4477a">
													<!--begin::Header-->
													<div class="px-7 py-5">
													...
													<div class="px-7 py-5">
														...
														<div class="mb-10">
															...
															<!--begin::Input-->
															<div>
																<select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_614858aa4477a" data-allow-clear="true">
																	<option></option>
															...
															<td>
																<div class="d-flex flex-column w-100 me-2">
																	<div class="d-flex" style="justify-content : end">
																		<a href="#" class="btn btn-sm btn-bg-light btn-active-color-primary me-3" data-bs-toggle="modal" data-bs-target="#kt_modal_users_search">Edit</a>
																		<a href="#" class="btn btn-sm btn-primary me-3" data-bs-toggle="modal" data-bs-target="#kt_modal_new_target">Add</a>
																	</div>
																</div>
															</td>
															<td class="text-end">
